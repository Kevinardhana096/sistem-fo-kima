...
function CustomerCreatePage({ onCancel, onNavigate }) {
    ...
    return (
        <div className="bg-surface text-on-surface">
            <CreateTopNav onToggleMenu={() => setIsMobileMenuOpen((prev) => !prev)} />
            {isMobileMenuOpen && (
                <CreateMobileDropdownMenu
                    activeSection="customers"
                    onClose={() => setIsMobileMenuOpen(false)}
                    onNavigate={handleMobileNavigate}
                />
            )}
            <CreateSidebar activeSection="customers" onNavigate={handleNavigate} />

            <main className="min-h-screen px-6 pb-10 pt-24 md:ml-64 md:px-12 md:pb-12">
                <section className="mx-auto w-full max-w-6xl">
                    <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                        <div>
                            <p className="mb-1 text-xs text-slate-500">Pelanggan | Tambah Data</p>
                            ...
                            <p className="mt-2 max-w-lg text-on-surface-variant">
                                Lengkapi data di bawah ini untuk mengarsipkan pelanggan baru ke dalam
                                sistem monitoring tenant.
                            </p>
                        </div>
                            ...
                            <div className="rounded-lg bg-surface-container-lowest p-8 shadow-sm">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="col-span-2 md:col-span-1">
                                        ...
                                        <select className="w-full rounded-lg border-none bg-surface p-3 text-sm focus:ring-2 focus:ring-primary/20">
                                            <option>Pilih ISP</option>
                                            <option>Indovision Fiber</option>
                            ...
                            <div className="rounded-lg bg-surface-container-lowest p-8 shadow-sm">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <textarea
                                            className="w-full rounded-lg border-none bg-surface p-3 text-sm focus:ring-2 focus:ring-primary/20"
                                            placeholder="Masukkan alamat korespondensi atau instalasi"
                                            rows="3"
                                        ></textarea>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <label className="block cursor-pointer">
                                        <div className="flex items-start gap-4 rounded-xl border-2 border-transparent bg-surface-container-lowest p-4">
                                            <input className="mt-1 text-primary focus:ring-primary" defaultChecked name="tech_type" type="radio" />
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="border-t border-slate-200 pt-4">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                className="w-full rounded-lg border-none bg-surface-container-lowest py-3 pl-10 pr-4 text-sm font-bold text-blue-900 focus:ring-2 focus:ring-primary/20"
                                                placeholder="0,00"
                                                type="text"
                                            />
                                        </div>
                                        <p className="mt-2 text-[10px] italic text-slate-500">
                                            * Biaya instalasi awal core dan perangkat.
                                        </p>
                                    </div>
                                </div>
                            </div>
...
function CreateTopNav({ onToggleMenu }) {
    return (
...
function CreateMobileDropdownMenu({ activeSection, onNavigate, onClose }) {
    return (
...
function CreateSidebar({ activeSection, onNavigate }) {
    return (
