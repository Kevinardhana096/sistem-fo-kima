...
export default function FoRouteMultiPreview({ tenants = [], entryPoints = [], ispLogoUrl = "", ispName = "", onTenantClick }) {
  ...
  return (
    <section className="space-y-4">
      {/* Map */}
      <div className="fo-route-preview-map relative z-0 overflow-hidden rounded-2xl border border-white/10 w-full aspect-square md:aspect-auto md:h-[560px] group hover:border-gold-accent/40 transition-all duration-500 hover:shadow-[0_0_20px_rgba(255,215,0,0.1)]">
